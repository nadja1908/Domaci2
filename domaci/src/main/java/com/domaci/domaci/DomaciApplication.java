package com.domaci.domaci;

import com.domaci.domaci.entity.Employee;
import com.domaci.domaci.repository.EmployeeRepository;
...
public class DomaciApplication implements CommandLineRunner {
	@Autowired
...
//		List<Employee> employees = this.employeeRepository.findByDepartmentName("Menadžment");
	...
	public static void main(String[] args) {
		SpringApplication.run(DomaciApplication.class, args);
	}
